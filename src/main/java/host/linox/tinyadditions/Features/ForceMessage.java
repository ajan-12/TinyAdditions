...
public class ForceMessage extends Feature {

    public ForceMessage(final JavaPlugin plugin) {
        super(FeatureType.FORCEMESSAGE);
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
        ...
        if (sender instanceof Player) {
            if (!sender.hasPermission("tinyadditions.forcemessage.use")) {
        ...
        target.chat(ChatColor.translateAlternateColorCodes('&', message.toString()));
        return true;
    }
